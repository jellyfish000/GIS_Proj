...
East Kalimantan faces its own set of challenges and concerns. With multiple factors of equal importance to consider, trade-off is involved for a big project like building a new city. Hence it is important to apply effective urban planning techniques so that city leaders are able to make more informed and balanced decisions.
...
Most of the area with higher hotspot intensity appeared close to the forest throughout the study area. For example, some of the hotspots appeared near forests such as peatlands along the Makahas river in Kota Samarinda and Kutai Kartanegara which could be due to dry season or deforestation.

![ports](https://user-images.githubusercontent.com/91875763/141743387-92bb9f86-91f5-4f44-97ee-5ed0217ce61a.png)
There are 2 International Airports found in two of the cities: Kota Samarinda and Kota Balikpapan which facilitates tourism and trade by providing access and connectivity to the global markets. 
Most of the seaports along the Mahakam river that flows through Kutai Kartanegara and Kota Samarinda. There are also some seaports found near the BALIKPAPAN bay and along rivers in Penajam Paser Utara.Inter-island ports located nearer to the coast at Muara Jawa, Kutai Kartanegara area are typically used to transport cargo for trading.


![roads](https://user-images.githubusercontent.com/91875763/141743393-e799f154-4332-465e-8779-947f7a61f4e0.png)
The distribution shows that there is high road connectivity within the study area especially in the city area of Kota Balikpapan and Kota Samarinda, which facilitates accessibility to urban services.
...
<img width="500" alt="result" src="https://user-images.githubusercontent.com/91875763/141743391-fcf094ca-01cd-40e5-84af-9e87b532987f.png">

#   Result

![site1](https://user-images.githubusercontent.com/91875763/141743399-f50ee268-98ed-487b-a1b3-27d2688cc578.png)
![site2](https://user-images.githubusercontent.com/91875763/141743405-8b905ed0-839c-4a39-b00a-fbbd29aae3cf.png)
